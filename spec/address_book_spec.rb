...
>>>>>>> ce36ad887277553b107f3e10dd0a995c4e462c57
...
<<<<<<< HEAD
  ...
  describe "#import_from_csv 2" do
    it "imports the correct number of entries" do
      ...
      book_size = book.entries.size
      puts ">>>>>>>> #{book_size.inspect}"
      puts ">>>>>> book: #{book.entries.inspect}"
...
<<<<<<< HEAD
    it "imports the 1st entry" do
      book.import_from_csv("entries_2.csv")
      entry_one = book.entries[0]
      check_entry(entry_one, "David", "555-555-1234", "david@kempner.com")
    end

    it "imports the 2nd entry" do
      book.import_from_csv("entries_2.csv")
      entry_two = book.entries[1]
      check_entry(entry_two, "Jenny", "555-555-1236", "jenny@kempner.com")
    end

    it "imports the 3rd entry" do
      book.import_from_csv("entries_2.csv")
      entry_three = book.entries[2]
      check_entry(entry_three, "Logan", "555-555-1235", "logan@kempner.com")
    end
  end
